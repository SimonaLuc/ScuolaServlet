...
<head>
    <meta charset="UTF-8">
    <title>Scuola Servlet Demo - Visualizza Iscritti</title>
    <style>
        body {
                text-align: center;
            }
...
<body>
    <h1>Seleziona Anno Scolastico</h1>

    <form action="ScuolaServlet" method="post">
        <input type="hidden" name="tipo_richiesta" value="visualizza_elenco_iscritti">
        ...
        <input type="submit" value="Visualizza elenco iscritti"><br><br>
    </form>
